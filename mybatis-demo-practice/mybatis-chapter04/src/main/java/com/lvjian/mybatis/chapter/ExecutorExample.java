...
/**
 * Title: ExecutorExample
 * Description: Executor类示例代码
 *
 * @author lvjian
 * @version 1.0.0
...
public class ExecutorExample {
    ...
    public void testExecutor() throws IOException, SQLException {
        ...
        MappedStatement listAllUserStmt = configuration.getMappedStatement("com.lvjian.mybaits.chapter.mapper.UserMapper.listAllUser");
        //创建ReuseExecutor实例
