package com.lvjian.mybatis.chapter.spring.configure;
...
@Configuration
@MapperScan(basePackages = {"com.lvjian.mybatis.chapter.spring.mapper"}, sqlSessionTemplateRef = "sqlSessionTemplate")
